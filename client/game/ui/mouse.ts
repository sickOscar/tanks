import {BOARD_HEIGHT, BOARD_WIDTH, GameState, HEX, OFFSET, SCROLL_AREA_WIDTH, States} from "../../consts";
import p5 from 'p5';
...
export function handleViewport(p5:p5) {
    ...
    if (p5.mouseY > p5.height - SCROLL_AREA_WIDTH) {
        const m = window.innerHeight - BOARD_HEIGHT - HEX.SIDE * 2;
    ...
    if (p5.mouseX > p5.width - SCROLL_AREA_WIDTH) {
        const m = window.innerWidth - 500 - BOARD_WIDTH - HEX.SIDE * 2;
